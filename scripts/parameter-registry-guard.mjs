...
assert.equal(registry.paperCapital.initialCapitalInr,50000000);
assert.equal(registry.paperCapital.minimumEntryValue,100000);
assert.equal(registry.paperCapital.maxPositionPct,10);
assert.equal(registry.paperCapital.cashBufferPct,5);
assert.equal(registry.paperCapital.maxCandidateEntries,80);
assert.equal(registry.paperCapital.minimumEntryPct,0.2);
assert.equal(registry.paperCapital.baseEntryPct,0.2);
assert.equal(registry.paperCapital.maxOpenPositions,500);
assert.equal(registry.paperCapital.affordableOpenPositionsAtMinimum,500);
assert.equal(registry.paperCapital.initialAffordableOpenPositionsAfterEntryCost,499);
