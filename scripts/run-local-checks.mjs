...
const allowed = new Set(["check", "guard", "test:mongo-memory", "test:paper-flow", "test:live-release", "test:institutional", "test:formula-parity", "test:rotation", "test:valuation", "test:official-market"]);
