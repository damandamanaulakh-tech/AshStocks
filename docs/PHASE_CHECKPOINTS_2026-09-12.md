...
| Mongo follow-up, 24 September | Bounded successful-event cache/queue, fewer duplicate archive writes, preserved history and isolated Mongo failure test | Published and verified `2781c63e3b7b39b1b40f097b17b5598f37d64d51`; exact 75-command/57-check proof in `MONGO_ARCHIVE_MEMORY_CHECKPOINT_2026-09-24.md`. Production symptom still needs an error/metric. No database cleanup or ambiguous file deletion. |
